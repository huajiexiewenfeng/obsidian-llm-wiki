...
| `obsidian-v02-phase4-doctor-consistency` | requirement | design-review | `requirements/obsidian-v02-phase4-doctor-consistency.md` | pending |
...
Review the written Phase 4 Doctor consistency design, then create its implementation plan. Phase 3.1 archive import and v0.3 Inventory remain separate flows.
