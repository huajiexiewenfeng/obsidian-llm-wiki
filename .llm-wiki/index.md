...
| `obsidian-v02-phase4-doctor-consistency` | requirement | implemented-agent-local | `requirements/obsidian-v02-phase4-doctor-consistency.md` | `handoff/obsidian-v02-phase4-doctor-consistency-handoff.md` |
...
Review the Phase 4 Doctor consistency branch, then choose its integration path. Phase 3.1 archive import and v0.3 Inventory remain separate flows.
