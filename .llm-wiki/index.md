...
Review the written v0.2 Phase 3 `ingest apply` and deterministic projection design, then create its implementation plan. Inventory remains deferred until the Phase 3 persistence path is stable.
