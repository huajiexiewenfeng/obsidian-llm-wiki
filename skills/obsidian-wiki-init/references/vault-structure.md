...
- `ingest/index.md`: ingest control-plane index for batches, source paths, wiki entries, status, and gaps.
...
- `sources/`: source indexes, source proxy nodes, source summaries, and ingestion reports.
